...
VALUES
    ('Базовый', '30 Мбит/с', 3990.00, 'Идеальный тариф для повседневного использования интернета',
     '["Скорость до 30 Мбит/с", "Безлимитный трафик", "Стабильное соединение", "Круглосуточная поддержка"]'::jsonb,
     true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

    ('Стандарт', '50 Мбит/с', 4990.00, 'Отличный выбор для семьи или малого бизнеса',
     '["Скорость до 50 Мбит/с", "Безлимитный трафик", "Просмотр HD видео", "Онлайн игры без лагов", "Круглосуточная поддержка"]'::jsonb,
     true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

    ('Премиум', '100 Мбит/с', 6990.00, 'Максимальная скорость для требовательных пользователей',
     '["Скорость до 100 Мбит/с", "Безлимитный трафик", "4K видео без буферизации", "Онлайн игры в высшем качестве", "Приоритетная техподдержка", "Статический IP адрес"]'::jsonb,
     true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

    ('Бизнес', '200 Мбит/с', 12990.00, 'Профессиональное решение для бизнеса',
     '["Скорость до 200 Мбит/с", "Безлимитный трафик", "Гарантированная скорость", "Статический IP адрес", "SLA 99.9%", "Выделенная линия поддержки", "Настройка оборудования"]'::jsonb,
     true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
